<?php 
	...
	{
	    $path = "https://imdb-api.com/en/API/InTheaters/".API." ";
...
<div class="container-fluid">
    <div class="row mt-3">
           <div style="text-align: center;"><h5 >In Theaters</h5><hr></div> <br><br><br>
       ...
       $url = admin_url('/admin.php?page=frontend&intheaters=intheaters');          
