 <?php 
	...
	{
	    $path = "https://imdb-api.com/en/API/YouTubeTrailer/".API."/tt1375666";
...
<div class="container-fluid">
    <div class="row mt-3">
           <div style="text-align: center;"><h5 >You Tube Trailer</h5><hr></div> <br><br><br>
               ...
               <div class="card p-0" >
                <div class="card-header p-0">
                    <div class="card-header-img-div">
                           <img src="<?php print_r($value['videoUrl']);?>" alt="" > 
                    </div>
                </div>
                <div class="card-body">
