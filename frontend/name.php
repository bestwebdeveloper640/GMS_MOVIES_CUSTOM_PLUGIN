<?php 
	...
	{
	    $path = "https://imdb-api.com/en/API/Name/".API."/nm0000154 ";
...
<div class="container-fluid">
    <div class="row mt-3">
           <div style="text-align: center;"><h5 >Name</h5><hr></div> <br><br><br>

        <?php 

			foreach($results['knownFor'] as $value){ ?>
       ...
       foreach($results['castMovies'] as $value){ ?>
