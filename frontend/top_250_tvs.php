...
{
    $path = "https://imdb-api.com/en/API/Top250TVs/".API." ";
...
<div class="container-fluid">
    <div class="row mt-3">
           <div style="text-align: center;"><h5>Top 250 TVs</h5><hr></div> <br><br><br>
...
// ------------------------pagination----------------------------
       ...
       $url = admin_url('/admin.php?page=frontend&top250tvs=top250tvs');          
